...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app-assets/js/scripts/pages/app-calendar.js":[function(require,module,exports) {
/**
 * App Calendar
 */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (eventLabel.length) {
    var renderBullets = function renderBullets(option) {
      if (!option.id) {
        return option.text;
      }
  ...
  if (eventGuests.length) {
    var renderGuestAvatar = function renderGuestAvatar(option) {
      ...
      var $avatar = "<div class='d-flex flex-wrap align-items-center'>" + "<div class='avatar avatar-sm my-0 mr-50'>" + "<span class='avatar-content'>" + "<img src='" + assetPath + 'images/avatars/' + $(option.element).data('avatar') + "' alt='avatar' />" + '</span>' + '</div>' + option.text + '</div>';
      return $avatar;
    };
  ...
  function _eventClick(info) {
    ...
    eventToUpdate.extendedProps.guests !== undefined ? calendarEditor.val(eventToUpdate.extendedProps.description) : null; //  Delete Event

    btnDeleteEvent.on('click', function () {
      eventToUpdate.remove(); // removeEvent(eventToUpdate.id);
  ...
  function fetchEvents(info, successCallback) {
    ...
    var calendars = selectedCalendars(); // We are reading event object from app-calendar-events.js file directly by including that file above app-calendar file.
  ...
  calendar.render(); // Modify sidebar toggler

  modifyToggler(); // updateEventClass();
  ...
  var updateEventInCalendar = function updateEventInCalendar(updatedEventData, propsToUpdate, extendedPropsToUpdate) {
    var existingEvent = calendar.getEventById(updatedEventData.id); // --- Set event properties except date related ----- //
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app-assets/js/scripts/pages/app-calendar.js"], null)
//# sourceMappingURL=/app-calendar.964e715a.js.map