...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app-assets/js/scripts/charts/chart-chartjs.js":[function(require,module,exports) {
/*=========================================================================================
...
$(window).on('load', function () {
  ...
  var chartWrapper = $('.chartjs'),
      ...
      lineAreaChartEx = $('.line-area-chart-ex'); // Color Variables
  ...
  if (radarChartEx.length) {
    var canvas = document.getElementById('canvas'); // For radar gradient color
    ...
    var polarExample = new Chart(polarAreaChartEx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: [primaryColorShade, warningColorShade, window.colors.solid.primary, infoColorShade, greyColor, successColorShade],
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app-assets/js/scripts/charts/chart-chartjs.js"], null)
//# sourceMappingURL=/chart-chartjs.d21b1e7f.js.map