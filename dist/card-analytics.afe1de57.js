...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app-assets/js/scripts/cards/card-analytics.js":[function(require,module,exports) {
...
$(window).on('load', function () {
  ...
  var $earningsChart = document.querySelector('#earnings-donut-chart'); // Support Tracker Chart
  // -----------------------------
  ...
  supportChart.render(); // Average Session Chart
  // ----------------------------------
  ...
  avgSessionChartOptions = {
    ...
    colors: [$avgSessionStrokeColor2, $avgSessionStrokeColor2, window.colors.solid.primary, $avgSessionStrokeColor2, $avgSessionStrokeColor2, $avgSessionStrokeColor2],
    series: [{
      name: 'Sessions',
  ...
  avgSessionChart.render(); // Revenue Report Chart
  // ----------------------------------
  ...
  budgetChart.render(); // Goal Overview  Chart
  // -----------------------------
  ...
  goalChart.render(); // Revenue  Chart
  // -----------------------------

  revenueChartOptions = (_revenueChartOptions = {
    chart: {
      height: 240,
      toolbar: {
        show: false
  ...
  }, _defineProperty(_revenueChartOptions, "grid", {
    padding: {
      top: -20,
      bottom: -10,
      left: 20
    }
  }), _defineProperty(_revenueChartOptions, "tooltip", {
    x: {
      show: false
    }
  }), _defineProperty(_revenueChartOptions, "series", [{
    name: 'This Month',
  ...
  revenueChart.render(); // Sales Chart
  // -----------------------------
  ...
  salesChart.render(); // Sales Line Chart
  // -----------------------------
  ...
  salesLineChart.render(); // Session Chart
  // ----------------------------------
  ...
  sessionChart.render(); // Customer Chart
  // -----------------------------
  ...
  customerChart.render(); // Product Order Chart
  // -----------------------------
  ...
  orderChart.render(); // Earnings Chart
  // -----------------------------
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app-assets/js/scripts/cards/card-analytics.js"], null)
//# sourceMappingURL=/card-analytics.afe1de57.js.map