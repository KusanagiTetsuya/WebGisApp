...
},{"process":"node_modules/process/browser.js"}],"app-assets/vendors/js/extensions/jstree.min.js":[function(require,module,exports) {
var define;
      ...
      this.init = function (a, b) {
        ...
        if (!e) {
          ...
          if (this._data.massload = {}, h.length) {
            ...
            if ("object" == _typeof(g) && g && g.url) return g = a.extend(!0, {}, g), a.isFunction(g.url) && (g.url = g.url.call(this, h)), a.isFunction(g.data) && (g.data = g.data.call(this, h)), a.ajax(g).done(a.proxy(function (a, g, h) {
              var i, j;
              if (a) for (i in a) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app-assets/vendors/js/extensions/jstree.min.js"], null)
//# sourceMappingURL=/jstree.min.a55c6d6d.js.map