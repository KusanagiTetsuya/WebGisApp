...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app-assets/js/scripts/cards/card-advance.js":[function(require,module,exports) {
/*=========================================================================================
...
$(window).on('load', function () {
  ...
  var userChats = $('.user-chats'); // init ps if it is not touch device
  ...
  employeePrimaryChart1.render(); // Employee Danger Chart
  ...
  employeeDangerChart.render(); // Employee Success Chart
  ...
  employeeSuccessChart.render(); // Employee Secondary Chart
  ...
  employeeSecondaryChart.render(); // Employee Warning Chart
  ...
  employeeWarningChart.render(); // Employee Primary Chart 2
  ...
  employeePrimaryChart2.render(); //---------------- State Charts ----------------
  //----------------------------------------------
  // State Primary Chart
  ...
  statePrimaryChart.render(); // State Warning Chart
  ...
  stateWarningChart.render(); // State Secondary Chart 1
  ...
  stateSecondaryChart.render(); // State Info Chart
  ...
  stateInfoChart.render(); // State Danger Chart
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app-assets/js/scripts/cards/card-advance.js"], null)
//# sourceMappingURL=/card-advance.6496a1da.js.map