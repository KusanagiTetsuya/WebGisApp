...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app-assets/js/core/app.js":[function(require,module,exports) {
/*=========================================================================================
  File Name: app.js
...
(function (window, document, $) {
  ...
  $('.navigation').find('li').has('ul').addClass('has-sub'); // $('.carousel').carousel({
  //   interval: 2000
  // });
  ...
  if ($body.attr('data-framework') === 'laravel') {
    ...
    $('.dropdown-language .dropdown-item').on('click', function () {
      ...
      $('#dropdown-flag .selected-language').text(selectedLang);
      $('#dropdown-flag .flag-icon').removeClass().addClass(selectedFlag);
      var currentLanguage = $this.data('language'); // i18next.changeLanguage(currentLanguage, function (err, t) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app-assets/js/core/app.js"], null)
//# sourceMappingURL=/app.789b21f0.js.map