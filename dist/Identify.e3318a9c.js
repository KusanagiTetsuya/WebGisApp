...
exports.WORKER_OFFSCREEN_CANVAS = exports.WEBKIT = exports.SAFARI = exports.PASSIVE_EVENT_LISTENERS = exports.MAC = exports.IMAGE_DECODE = exports.FIREFOX = exports.DEVICE_PIXEL_RATIO = void 0;
...
var _CustomFunction = require("./CustomFunction");
...
map.on('singleclick', function (evt) {
  if ($('#draggable-title').text() !== "Measure") {
    var coordinate = evt.coordinate; //Get the layer by it's name

    var parcelLayer = (0, _CustomFunction.getLayerByName)('Parcels');
    var parcelSource = parcelLayer.getSource();
    var buildingLayer = (0, _CustomFunction.getLayerByName)('Buildings');
    ...
    buildingInfo.html('');
    var coordinateInfo = $('#select-coordinate');
    coordinateInfo.html('');
    var noFeatures = $('#no-features');
    noFeatures.html('<p>No Features</p>');
    var parcelUrl = parcelSource.getFeatureInfoUrl(coordinate, resolution, projection, {
      'INFO_FORMAT': 'application/json'
    });
    var buildingUrl = buildingSource.getFeatureInfoUrl(coordinate, resolution, projection, {
      'INFO_FORMAT': 'application/json'
    });
    var checkStatus = 0;
    $('.form-check-input').click(function () {
      if (this.prop("checked") == true) {
        1, _readOnlyError("checkStatus");
      }
    });
    ...
    var selectedCoordinate = (0, _coordinate.toStringXY)((0, _proj.transform)(coordinate, 'EPSG:3857', 'EPSG:4326'), 14);
    coordinateInfo.html("<p>Coordinate: ".concat(selectedCoordinate, "</p>"));
    overlay.setPosition(coordinate);
  }
});
},{"ol/ol.css":"node_modules/ol/ol.css","ol/Overlay":"node_modules/ol/Overlay.js","ol/proj":"node_modules/ol/proj.js","ol/coordinate":"node_modules/ol/coordinate.js","./CustomFunction":"scripts/CustomFunction.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/Identify.e3318a9c.js.map